						...
						<div class="product_box fl">
							...
							<div class="btn_box flc">
								...
								<div>
									...
									<span style="color: #F24024;">${listwall.commentNum}</span>
								</div>
								<!--comment end -->
							</div>
								...
								<div class="block_comments imgbuttion">
									<div class="comment imgwall_comment">
										<div class="walluserpic userpic">
											<a href="#"><img src="${wallcomment.user.username}" alt="${wallcomment.user.username}" /></a>
										</div>
										<div class="content">
											<p>
												<span class="name">
							...
							<div class="comment_show imgbuttion">
								<input type="text" class="imgwall_id" value="${t.id}"/>
