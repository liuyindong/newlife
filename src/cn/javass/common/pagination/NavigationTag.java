...
public class NavigationTag extends TagSupport
{
	...
	private String makeNext(Page<?> page, String url)
	{
		...
		sb.append("<input type=\"text\" name=\"pn\" size=\"3\" value=\"1\" format=\"*N\"/>").append(page.getIndex()).append("/").append(page.getContext().getPageCount()).append("页<anchor>跳转<go href=\"").append(url).append("\" method=\"get\" accept-charset=\"utf-8\">").append("<postfield name=\"pn\" value=\"$pn\"/></go></anchor><br/>");
