...
public class Test003
{
	...
	public static void main(String[] args)
	{
		...
		// 获取整个虚拟机内存使用情况
		System.out.println("=======================MemoryMXBean   获取整个虚拟机内存使用情况============================ ");
		...
		System.out.println("=======================ThreadMXBean  获取各个线程的各种状态，CPU 占用情况，以及整个系统中的线程状况============================ ");
		...
		// 当前编译器情况
		System.out.println("=======================CompilationMXBean 当前编译器情况============================ ");
		CompilationMXBean gm = (CompilationMXBean) ManagementFactory.getCompilationMXBean();
		System.out.println("getName " + gm.getName());
		System.out.println("getTotalCompilationTime " + gm.getTotalCompilationTime());

		// 获取多个内存池的使用情况
		System.out.println("=======================MemoryPoolMXBean  获取多个内存池的使用情况============================ ");
		...
		// 获取GC的次数以及花费时间之类的信息
		System.out.println("=======================MemoryPoolMXBean  获取GC的次数以及花费时间之类的信息============================ ");
		...
		// 获取运行时信息
		System.out.println("=======================RuntimeMXBean 获取运行时信息============================ ");
