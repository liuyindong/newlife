...
public class InternetScrollServiceImpl extends BaseService<InternetScroll, Integer> implements InternetScrollService
{
	...
	@Override
	public void setBaseDao(IBaseDao<InternetScroll, Integer> internetScrollDao)
	{
